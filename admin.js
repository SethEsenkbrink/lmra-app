...
// --- NIEUWE LOGOUT FUNCTIE (Hard Reset) ---
function handleLogout() {
    if (!confirm("Weet u zeker dat u wilt uitloggen?")) return;
    
    // 1. Vernietig de cookie onmiddellijk
    document.cookie = "nf_jwt=; path=/; max-age=0; expires=Thu, 01 Jan 1970 00:00:00 GMT; SameSite=Strict; Secure";
    
    // 2. Log uit bij de widget (cleart localstorage)
    if (window.netlifyIdentity) {
        window.netlifyIdentity.logout();
    }
    
    // 3. Stuur direct terug naar de homepage (de app)
